...
var Container = React.createClass({displayName: "Container",
            ...
            updateCurrentProject: function(projectName) {
              if (this.isAnimating ===   true) e.preventDefault();
              if (this.state.showListView ===  false) e.preventDefault();
            ...
            render: function() {
              ...
              var projectDetailsView = React.createElement("div", {className: "projectDetailsView backgroundView"}, 
              ...
              return (
                React.createElement("div", {id: "mainView", className: overallState}, 
                  ...
                  React.createElement("div", {className: "projectListView backgroundView"}, 
                    React.createElement("h1", {style: listColor}, " Will Melbourne"), 
                    React.createElement("div", {className: "introTextContainer"}, 
